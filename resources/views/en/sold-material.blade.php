        ...
        <div class="container">
            <div class="row">
				<div class="col-md-3">
					...
					@include('en.content.nav-individual')
				</div>
				<div class="col-md-9">
					<div class="fold_box p-5">
						<h1 class="mb-3">Sold Material</h1>
						@foreach($scrap as $scrapdata)
						<div class="pro_box_ind">
							...
							<p class="head"><a href="pro-dtl.htm">{{$scrapdata->scrap_category}}</a></p>
							<p class="amnt">{{$scrapdata->price}} <span>/ ton</span></p>
							<p class="selr">Seller : {{$name}}</p>
						</div>
						@endforeach
						<p class="clearfix"></p>
					</div>
