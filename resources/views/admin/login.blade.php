                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body pt-0">
                                ...
                                <div class="p-3">
                                    ...
                                    <form method="POST" class="form-horizontal mt-4" id="myForm" action="{{ route('login') }}">
            @csrf
                                        ...
                                        <div class="mb-3 row mt-4">
                                            ...
                                            <x-button id="btnSubmit" type="submit" class="btn btn-primary w-md waves-effect waves-light" class="login_btn">Login</x-button>
